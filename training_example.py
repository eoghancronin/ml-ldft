...
f = load_datasets(sets = ['data/exact_data/L18_num15000.pkl', 'data/exact_data/L21_num15000.pkl', 'data/exact_data/L24_num15000.pkl',
                     'data/exact_data/L18_num1000_electric_field.pkl', 'data/exact_data/L21_num1000_electric_field.pkl', 'data/exact_data/L24_num1000_electric_field.pkl',
                     'data/exact_data/L18_num1866_high_disorder.pkl', 'data/exact_data/L18_num1866_high_disorder.pkl', 'data/exact_data/L18_num1866_high_disorder.pkl',
                     'data/exact_data/L24_num64_zeros.pkl'],
             L_max = L, a=a)  
...
v_up_f = rm(v_up_f)
v_dn_f = rm(v_dn_f)
v_up_tot = (v_up+ v_up_f)/10 # Dividing the xc potential by 10 (as well as the training data) so that the energies and potentials
v_dn_tot= (v_dn + v_dn_f)/10 # are on a similar scale. Much easier than customizing a loss function.
s_tot = s + s2               
